...
module ALU_test();
    ...
    begin
        ...
        $readmemh ("testvectors.txt", test_cases);
    ...
    assign exp_zero = (expected_result == 32'd0);
    ...
    ALU UUT(test_cases[94:63], test_cases[62:31], test_cases[99:95], result, zero);
